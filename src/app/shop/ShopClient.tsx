...
export default function ShopClient({ initialProducts, categories, types, brands }: ShopClientProps) {
    ...
    return (
        <main>
            ...
            <div className="shop-product breadcrumb1 mt-16 md:mt-24 lg:py-20 md:py-14 py-10">
                            ...
                            <div className="filter-heading flex items-center justify-between gap-5 flex-wrap">
                                ...
                                <div className="sort-product right flex items-center gap-3">
                                    ...
                                    <div className="select-block relative">
                                        ...
                                        <svg className="w-4 h-4 absolute top-1/2 -translate-y-1/2 md:right-4 right-2 pointer-events-none" fill="none" stroke="currentColor" viewBox="0 0 24 24">
